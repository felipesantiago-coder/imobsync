...
/**
 * PATCH em lote das unidades Moment (tabela `moment_units`).
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const result = await applyBatchStatusUpdate({
      ...
      resolveColumns: "id, status, unidade",
      empreendimentoRef: "moment",
    ...
    console.error("Erro no PATCH /api/moment-units/batch:", err);
