        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <img src="/imobsync-icon-escuro-36.png" alt="ImobSync" className="h-10 w-auto rounded-xl" />
              <div>
            ...
            <div className="bg-gradient-to-br from-[#0D1B2A] to-[#0D1B2A] rounded-2xl shadow-lg p-6 text-white">
              ...
              <div className="mt-6">
                ...
                {result.captationPercent > 0 && result.captationPercent < MIN_CAPTATION_PERCENT && (
                  <p className="text-red-300 text-xs mt-2 text-right">Mínimo: {MIN_CAPTATION_PERCENT}%</p>
                )}
              </div>
